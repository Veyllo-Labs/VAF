...
class MemorySearchTool(BaseTool):
    ...
    description = (
        ...
        "It does NOT hold live data: to read the user's actual EMAILS or CHATS use inbox (NEVER memory_search), "
        "then read_mail / read_whatsapp_chat / read_telegram_chat, for the CALENDAR use the calendar tools. Never call memory_search to look up emails or messages. "
