                                ...
                                <>
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        <button onClick={handleSaveAdminOAuth} disabled={adminSaveStatus === 'saving'}
                                            className="px-4 py-2 rounded-xl text-sm font-medium bg-gray-900 text-white hover:bg-gray-800 disabled:opacity-50 dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none">
                                        ...
                                        return (
                                            <li key={a.account_id} className="p-4 rounded-xl border border-gray-200 bg-white shadow-sm">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-3">
                                                        <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center text-white", opt?.iconColor || "bg-gray-900 dark:bg-[#2e2e2e]")}>
