...
See [CONNECTIONS.md](CONNECTIONS.md) for how to configure contacts and the "Can reach your assistant" toggle.
...
- [CONNECTIONS.md](CONNECTIONS.md) – Contacts, “Can reach your assistant”, and the short Front Office behaviour subsection.
- [USER_IDENTITY.md](USER_IDENTITY.md) – User identity and system prompt injection for the current user (owner).
