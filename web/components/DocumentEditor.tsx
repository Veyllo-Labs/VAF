...
function LegacyDocumentEditor({
    ...
    const toolbar = (
        ...
        >
            ...
            <button type="button" onClick={exportAsPDF} disabled={isExportingPdf} className="flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-medium text-white bg-blue-500 hover:bg-blue-600 disabled:opacity-50 dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none" title="Download as PDF file">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                                {isBinaryDocument && (
                                    <a
                                        ...
                                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-md transition-colors dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none"
                                    >
                                        <Download size={14} />
                                        Download
                                    </a>
                            ...
                            {isBinaryDocument ? (
                                <div className="flex flex-1 flex-col items-center justify-center gap-4 p-6 text-center bg-white">
                                    ...
                                    <a
                                        href={`${getApiBase()}/api/file?path=${encodeURIComponent(filePath)}`}
                                        download={displayFile}
                                        className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none"
                                    >
                                        <Download size={16} />
                                        Download file
                                    </a>
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            {isBinaryDocument && (
                                <a
                                    href={`${getApiBase()}/api/file?path=${encodeURIComponent(filePath)}`}
                                    download={displayFile}
                                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none"
                                >
                                    <Download size={14} />
                                    Download
                                </a>
                        ...
                        {isBinaryDocument ? (
                            <div className="flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center bg-white">
                                ...
                                <a
                                    href={`${getApiBase()}/api/file?path=${encodeURIComponent(filePath)}`}
                                    download={displayFile}
                                    className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none"
                                >
                                    <Download size={18} />
                                    Download file
                                </a>
