...
- **Contact with Front Office doesn't get a reply**:
  - The contact must have their **WhatsApp number** in the contact's **Channels** (phone/WhatsApp, E.164 e.g. +4917642996812). Add it in Settings → Connections → Contacts → edit contact → Channels.
