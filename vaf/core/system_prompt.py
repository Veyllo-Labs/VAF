...
| `send_whatsapp` | **Send content via WhatsApp** (message; optional to_phone for a contact, voice_lang for Sprachnachricht, file_path for PDF). Use to_phone with contact's whatsapp_phone from get_contact when user asks to send to someone (e.g. Anne) | Send to owner or to contact (to_phone) |
| `whatsapp_inbox` | **List WhatsApp chats** (like mail_inbox). Returns chat_id, name, last_ts. Use find_whatsapp_messages to search; read_whatsapp_chat to read a chat | When user asks "list WhatsApp chats", "find messages from Anne" |
| `find_whatsapp_messages` | **Search WhatsApp messages** by query (matches body, chat name, sender). Optional chat_id to limit. Use when user asks "find messages from Anne", "what did X say" | find_whatsapp_messages(query="Anne") |
...
""")
        ...
        if front_office:
            fo_role = (
                ...
                "- Schreibe KEINE Meta-Berichte wie \"Ich habe Anne geantwortet...\", \"Ich habe dem Kontakt mitgeteilt...\" oder \"Ich werde Anne informieren...\". "
                ...
                "### Sprache\n"
                "Antworte in der Sprache des Kontakts (erkannt aus der Nachricht oder aus `preferred_language` im Kontakt-Block). "
                "Wechsle NICHT in die Sprache des Inhabers.\n\n"
                "### Grenzen\n"
                ...
                "3. Die Nachricht an den Inhaber soll **kurz und informativ** sein — Kontaktname + Kerninhalt (z.B. \"Anne bittet dich, sie zurückzurufen\").\n\n"
                ...
                "- Do NOT write meta-reports like \"I told Anne...\", \"I have informed the contact...\", or \"I will let Anne know...\". "
                ...
                "### Language\n"
                "Reply in the contact's language (detected from their message or from `preferred_language` in the contact block). "
                "Do NOT switch to the owner's language.\n\n"
                "### Boundaries\n"
                ...
                "3. The message to the owner should be **short and informative** — contact name + key content (e.g. \"Anne asks you to call her back\").\n\n"
