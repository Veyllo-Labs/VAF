                ...
                <form onSubmit={handleSubmit} className="max-md:flex-1 max-md:flex max-md:flex-col max-md:min-h-0">
                    ...
                    <div className="flex items-center justify-between gap-3 p-6 border-t border-gray-200 bg-gray-50 max-md:p-4 max-md:shrink-0">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="bg-gray-900 hover:bg-gray-800 text-white px-6 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-white dark:shadow-none"
                        >
