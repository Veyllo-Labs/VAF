                                ...
                                <div className="p-4 rounded-xl bg-gray-50 border border-gray-200">
                                    ...
                                    {!whitelistAdded ? (
                                        <button
                                            ...
                                            className="mt-3 flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-900 hover:bg-gray-800 text-white font-medium disabled:opacity-50 dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-white dark:shadow-none"
                                        >
