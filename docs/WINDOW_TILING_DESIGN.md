...
"How frames reach the UI" section of [Browser Agent](BROWSER_AGENT.md).
...
See also [Workflow UI Components](WORKFLOW_UI_COMPONENTS.md) and [Browser Agent](BROWSER_AGENT.md).
