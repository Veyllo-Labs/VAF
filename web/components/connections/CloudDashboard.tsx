                    ...
                    {accounts.length > 0 && (
                        <div className="flex items-center gap-2 flex-1 max-w-md min-w-0">
                            ...
                            <button
                                ...
                                className="shrink-0 px-3 py-2 rounded-lg bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none"
                            >
                        ...
                        <div className="flex-1 overflow-y-auto p-3">
                            {loading ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-8 text-center">
                                    ...
                                    <button type="button" onClick={() => onOpenAddWizard()} className="mt-4 w-full inline-flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-[#f5f5f5] dark:shadow-none">
