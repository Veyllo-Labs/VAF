...
| anyone else | `not_paired` | not answered: the message is stored for you (the dashboard shows the chat as read-only, the inbox tools read it), no agent run, security event `channel_rejected` |
