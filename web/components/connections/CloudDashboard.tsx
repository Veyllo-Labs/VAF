...
import { X, Cloud, Loader2, UserPlus, RefreshCw, FolderOpen, HardDrive, FolderSync, File, ChevronRight, Home } from 'lucide-react';
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">Browse your cloud storage</p>
                        </div>
                    </div>
