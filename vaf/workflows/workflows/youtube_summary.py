    ...
    "steps": [
        ...
        },
        {
            ...
            "input": (
                ...
                "Struktur: '# <Videotitel>' als Überschrift, eine Zeile '**Quelle:** {video_url}', "
                "dann '## Kurzfassung' (3-5 Sätze), '## Kernpunkte' (Bullets), optional "
                "'## Details' für erkennbare Abschnitte, zum Schluss '## Fazit' (1-2 Sätze).\n"
                ...
                "(später erneut versuchen). Erfinde NIEMALS Inhalte.\n"
                ...
                "(Ein früherer Lauf hat hier 6 Minuten mit eigenen Fetch-Versuchen verbrannt.)\n\n"
