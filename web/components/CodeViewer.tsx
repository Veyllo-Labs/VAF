    ...
    <div className="flex flex-col h-full w-full bg-[#1e1e1e] text-white overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-3 py-2 bg-[#2d2d2d] border-b border-[#3e3e3e] shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs px-2 py-1 rounded bg-blue-600 hover:bg-blue-500 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shrink-0 dark:bg-[#e6e6e6] dark:text-[#181818] dark:hover:bg-white dark:shadow-none"
          title="Save (Ctrl+S)"
        >
          {isSaving ? (
