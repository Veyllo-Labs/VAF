...
- [CONTEXT_MANAGEMENT.md](CONTEXT_MANAGEMENT.md) — system prompt assembly and context/token handling
- [TOOL_ROUTER_ARCHITECTURE.md](TOOL_ROUTER_ARCHITECTURE.md) — tool selection and the `input_examples` description channel
- [WEB_UI.md](WEB_UI.md) — Web UI structure and message rendering
