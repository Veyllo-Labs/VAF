...
| `send_whatsapp` | **Send content via WhatsApp** (message; optional voice_lang for Sprachnachricht, file_path for PDF/document). Use when user asked for report, notes, or PDF via WhatsApp | Send text, voice, or document |
